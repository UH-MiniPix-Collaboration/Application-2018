...
\begin{figure}[]
  \begin{minipage}[c]{0.49\linewidth}
    ...
    \caption{3D rendering of the MiniPIX case and heat sink assembly. \cmt{Andrew R}{The left figure is not showing up.}} %make sure to put figure names underneath the pictures
